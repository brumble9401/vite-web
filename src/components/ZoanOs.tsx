  ...
  return (
    <div className="bg-black w-full h-full flex flex-col items-center justify-center">
        <div className="relative w-full max-w-[800px] px-4 md:px-8">
          ...
          <div className="bg-purple-500 w-fit mx-auto h-fit my-20 rounded-[28px]"
            style={{
              background: 'linear-gradient(to bottom, rgba(75, 64, 154, 0.5), rgba(150, 170, 248, 0.5))'
            }}
          >
          <div className="relative overflow-hidden p-2">
            <div
              className="relative mx-auto w-full max-w-[560px] h-[560px] bg-indigo-900 rounded-[24px] overflow-hidden z-0"
              style={{
            ...
            >
              ...
              />
              <div className="absolute max-w-full h-[38px] w-full text-white font-ubuntu overflow-hidden whitespace-nowrap pt-3 bg-white/10 text-xs px-2">
