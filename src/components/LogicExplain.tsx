...
//   return (
//     <div className="border-[0.5px] md:w-[800px] h-full border-green-500 flex flex-row gap-6">
//       <div className="border-r-[0.5px] border-green-500 w-full">
//         <div className="flex flex-col items-start justify-evenly h-full p-10 gap-10">
//           <div className="relative">
//             <div className="uppercase font-luckiest -rotate-1 bg-green-300 w-fit px-2 pt-2 text-black font-bold text-[30px] py-auto">
//               Logic Compiler
//             </div>
//             <div className="uppercase absolute top-11 mx-auto w-fit left-[0.5px] font-luckiest -rotate-1 bg-purple-300 px-2 py-1 text-black font-bold text-[30px] pt-3">
//               Architecture
//             </div>
//           </div>
//           <div className="text-white/50 font-ubuntu mt-14">
...
//         </div>
//       </div>
//       <div className="border-l-[0.5px] border-green-500 w-full">
//         <div className="flex flex-col items-start justify-evenly h-full p-10 gap-10">
//           <div className="relative">
//             <div className="uppercase font-luckiest -rotate-1 bg-green-300 w-fit px-2 pt-2 text-black font-bold text-[30px] py-auto">
//               The Sandbox
...
export const LogicExplain = () => {
  return (
    <div className="border-[0.5px] border-green-500 w-full md:w-[800px] flex flex-col md:flex-row gap-6">
      {/* Left Block */}
      <div className="md:border-r-[0.5px] border-b-[0.5px] border-green-500 w-full">
        <div className="flex flex-col items-start justify-evenly h-full p-6 md:p-10 gap-6 md:gap-10">
          ...
          <div className="text-white/50 font-ubuntu mt-10 text-sm sm:text-base">
            The GLB is the transformation core of Zoanetic, which interacts
            directly with the user's natural request. This engine takes in the
            raw request from the user and transforms it into a GLB.
          </div>
      ...
      {/* Right Block */}
      <div className="md:border-l-[0.5px] border-t-[0.5px] border-green-500 w-full">
        <div className="flex flex-col items-start justify-evenly h-full p-6 md:p-10 gap-6 md:gap-10">
          <div className="relative">
            <div className="uppercase font-luckiest -rotate-1 bg-green-300 w-fit px-2 pt-2 text-black font-bold text-xl sm:text-2xl md:text-[30px]">
              The Sandbox
