...
//       <div className="relative z-20 p-4 m-[120px] bg-black">
//         <div className="relative z-20 h-fit bg-black flex flex-col">
//           <div className=" flex flex-row items-center justify-between  px-20">
//             <div className="relative">
//               <div className="uppercase font-luckiest -rotate-1 bg-green-300 w-fit px-2 pt-2 text-black font-bold text-4xl py-auto">
//                 Logic Compiler
//               </div>
//               <div className="uppercase absolute top-11 mx-auto w-fit left-[0.5px] font-luckiest -rotate-1 bg-purple-400 px-2 py-1 text-black font-bold text-[60px]">
//                 <div className="translate-y-[10px]">Architecture</div>
//               </div>
//             </div>
//             <img src={zoanFire} className="w-[400px] h-[400px]" />
//           </div>
//           <div className="relative z-20 bg-purple-200 w-full h-fit flex flex-row px-20 py-10">
//             <div className="w-[40%]"></div>
//             <div className="font-ubuntu text-black w-full">
